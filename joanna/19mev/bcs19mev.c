...
#include "filepaths_19mev.h"	// Header file with all the important file path and names
#include "fitfunctions_19mev.c"	// Code that takes care of fitting functions.
...
int bcs19mev(void){
	...
	char	tree5STR[]		= GI_TREE4;
	char	tree6STR[]		= GO_TREE0;
	char	tree7STR[]		= GO_TREE1;
...
int menu(int* angle, char* menCho){
	...
	/* Creates user menu. */
	printf("\n\nWelcome to the 19 MeV TUNL analysis of the Summer 2018 Argon run.\n");
	printf("The filled sample cell runs are 3676, 3677, 3678, 3679, and 3680. The empty runs\n");
	printf("are 3700 and 3701. Select an option below and then select the angle to be analyzed.\n");

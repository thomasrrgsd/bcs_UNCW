...
Double_t gaussianpeak(Double_t *x, Double_t *par) {
	...
	if (par[0]) {
	  ...
	  arg2 = (x[0] - par[1] + 40.3)/par[0];
	  arg3 = (x[0] - par[1] + 49.1)/par[0];
	  arg4 = (x[0] - par[1] + 66.3)/par[0];
	  arg5 = (x[0] - par[1] + 93.4)/par[0];
...
//********************************************************************
	...
	fitfunc2->SetParameter(1,0);  		//linear

...
#include "filepaths_25mev.h"	// Header file with all the important file path and names
#include "fitfunctions_25mev.c"	// Code that takes care of fitting functions.
...
int bcs25mev(void){
	...
	char	tree6STR[]		= GO_TREE1;
	char	tree7STR[]		= GO_TREE2;
	char	tree8STR[]		= GO_TREE3;
	char	tree9STR[]		= GO_TREE4;
	...
	fprintf(fLog, "\nPath for gas in tree 3681: %s", tree1STR);
	fprintf(fLog, "\nPath for gas in tree 3682: %s", tree2STR);
	fprintf(fLog, "\nPath for gas in tree 3687: %s", tree3STR);
	fprintf(fLog, "\nPath for gas in tree 3688: %s", tree4STR);
	fprintf(fLog, "\nPath for gas out tree 3690: %s", tree5STR);
	fprintf(fLog, "\nPath for gas out tree 3691: %s", tree6STR);
	fprintf(fLog, "\nPath for gas out tree 3692: %s", tree7STR);
	fprintf(fLog, "\nPath for gas out tree 3693: %s", tree8STR);
	fprintf(fLog, "\nPath for gas out tree 3694: %s", tree9STR);
	fprintf(fLog, "\n\n");
...
//******************************************************************************************************
//option 1: generate 2d histograms
//******************************************************************************************************
...
int hist_2D(void){
		...
		for (i = 0; i < 21; i++)
		{
			ch1.SetBranchAddress(leafPH[i], &ph1[i]);
			ch1.SetBranchAddress(leafPSD[i], &psd1[i]);
			ch2.SetBranchAddress(leafPH[i], &ph2[i]);
			ch2.SetBranchAddress(leafPSD[i], &psd2[i]);
		}

		/* Fill in the pointers to our histograms. We will fill them in and write them later. */
		h1[0] = new TH2F("phPSD0Tin", "0 Degree Top PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[1] = new TH2F("phPSD0Min", "0 Degree Middle PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[2] = new TH2F("phPSD0Bin", "0 Degree Bottom PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[3] = new TH2F("phPSD3Tin", "3 Degree Top PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[4] = new TH2F("phPSD3Min", "3 Degree Middle PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[5] = new TH2F("phPSD3Bin", "3 Degree Bottom PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[6] = new TH2F("phPSD6Tin", "6 Degree Top PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[7] = new TH2F("phPSD6Min", "6 Degree Middle PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[8] = new TH2F("phPSD6Bin", "6 Degree Bottom PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[9] = new TH2F("phPSD9Tin", "9 Degree Top PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[10] = new TH2F("phPSD9Min", "9 Degree Middle PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[11] = new TH2F("phPSD9Bin", "9 Degree Bottom PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[12] = new TH2F("phPSD12Tin", "12 Degree Top PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[13] = new TH2F("phPSD12Min", "12 Degree Middle PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[14] = new TH2F("phPSD12Bin", "12 Degree Bottom PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[15] = new TH2F("phPSD15Tin", "15 Degree Top PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[16] = new TH2F("phPSD15Min", "15 Degree Middle PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[17] = new TH2F("phPSD15Bin", "15 Degree Bottom PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[18] = new TH2F("phPSD18Tin", "18 Degree Top PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[19] = new TH2F("phPSD18Min", "18 Degree Middle PH vs Psd In", 128, 0., 4095, 128, 0.,4095);
		h1[20] = new TH2F("phPSD18Bin", "18 Degree Bottom PH vs Psd In", 128, 0., 4095, 128, 0.,4095);

		h2[0] = new TH2F("phPSD0Tout", "0 Degree Top PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[1] = new TH2F("phPSD0Mout", "0 Degree Middle PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[2] = new TH2F("phPSD0Bout", "0 Degree Bottom PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[3] = new TH2F("phPSD3Tout", "3 Degree Top PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[4] = new TH2F("phPSD3Mout", "3 Degree Middle PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[5] = new TH2F("phPSD3Bout", "3 Degree Bottom PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[6] = new TH2F("phPSD6Tout", "6 Degree Top PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[7] = new TH2F("phPSD6Mout", "6 Degree Middle PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[8] = new TH2F("phPSD6Bout", "6 Degree Bottom PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[9] = new TH2F("phPSD9Tout", "9 Degree Top PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[10] = new TH2F("phPSD9Mout", "9 Degree Middle PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[11] = new TH2F("phPSD9Bout", "9 Degree Bottom PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[12] = new TH2F("phPSD12Tout", "12 Degree Top PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[13] = new TH2F("phPSD12Mout", "12 Degree Middle PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[14] = new TH2F("phPSD12Bout", "12 Degree Bottom PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[15] = new TH2F("phPSD15Tout", "15 Degree Top PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[16] = new TH2F("phPSD15Mout", "15 Degree Middle PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[17] = new TH2F("phPSD15Bout", "15 Degree Bottom PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[18] = new TH2F("phPSD18Tout", "18 Degree Top PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[19] = new TH2F("phPSD18Mout", "18 Degree Middle PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);
		h2[20] = new TH2F("phPSD18Bout", "18 Degree Bottom PH vs Psd Out", 128, 0., 4095, 128, 0.,4095);


		//h1[0] -> TAttMarker::SetMarkerStyle(kFullDotMedium);

		for(i = 0; i < 21; i++)
			{
				h1[i]->TAttMarker::SetMarkerStyle(kFullDotMedium);
				h2[i]->TAttMarker::SetMarkerStyle(kFullDotMedium);
			}


		printf("Now beginning histogram generation...\n\n");

		printf("%lld gas in entries will be read.\n", ch1.GetEntries());

		/* First loop that creates the gas in histograms. */
		for(i = 0; i <=ch1.GetEntries(); i++)
		//for(i = 0; i <=100; i++)
		{
			ch1.GetEvent(i);
			printf("\r%d", i);
			...
			//for(j = 0; j < 1; j++)
			{
				if((ph1[j] >= 0) && (ph1[j] <= 4095) && (psd1[j] >= 0) && (psd1[j] <= 4095))
				{
					h1[j]->Fill(psd1[j], ph1[j]);
					//printf("\n %d %d \n", i, j);
				}
			}
		}
		...
		ch1.ResetBranchAddresses();

		printf("\n\n%lld gas out entries will be read.\n", ch2.GetEntries());

		/* Second loop that creates the gas out histograms. */
		for(i = 0; i <= ch2.GetEntries(); i++)
		//for(i = 0; i <= 100; i++)
		{
			ch2.GetEvent(i);
			printf("\r%d", i);
			...
			//for(j = 0; j < 1; j++)
			{
				if((ph2[j] >= 0) && (ph2[j] <= 4095) && (psd2[j] >= 0) && (psd2[j] <= 4095))
				{
					h2[j]->Fill(psd2[j], ph2[j]);
				}
			}
		}
		...
		f1->Close();
		ch2.ResetBranchAddresses();

		printf("\n\nCompleted generating two dimensional histograms. They are useful for making cuts.\n");
...
//******************************************************************************************************
//option 2: apply cuts to histograms
//******************************************************************************************************
...
int Paint_Cuts(void){
	...
	f1 = new TFile(PHPSD, "READ");
	f2 = new TFile(CUTPATH, "READ");
	f3 = new TFile(PHPSDCUT, "CREATE");

	/* Checks if TFile was successfully opened. */
	if(f1->IsZombie())
	{
		printf("\nFile path of the histogram results does not exist. Update filepaths.h\n");
		return 1;
	}
	...
	for (i = 0; i < 3; i++)
	{
		h = (TH2F*)f1->Get(hSTR[i]);
		hClone = (TH2F*)f1->CloneObject(h);
		f2->GetObject(cutSTR[i], tCutG);
		strcpy(objName, hSTR[i]);
		strcat(objName, "wcut");
		c1[i] = new TCanvas(objName, objName);
		c1[i]->cd();
		h->Draw();
		tCutG->Draw("SAME");
		c1[i]->Write();
	...
	printf("\nThe specified cuts have been painted over the associated 2D histograms");
	f1->Close();
	f2->Close();
...
int menu(int* angle, char* menCho){
	...
	/* Creates user menu. */
	printf("\n\nWelcome to the 25 MeV TUNL analysis of the Summer 2018 Argon run.\n");
	printf("The filled sample cell runs are 3681, 3682, 3687, and 3688. The empty runs\n");
	printf("are 3690, 3691, 3692, 3693, and 3694. Select an option below and then select the angle to be analyzed.\n");

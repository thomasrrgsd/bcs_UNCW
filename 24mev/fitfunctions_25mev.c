...
Double_t scalefactor = 0.79;

// Quadratic background function.
Double_t background(Double_t *x, Double_t *par) {
//	return par[0] + par[1]*x[0] + par[2]*x[0]*x[0];
	return TMath::Exp(par[1]*(par[0] + x[0])) + par[2];// + par[2]*x[0]*x[0]);
}
...
Double_t gaussianpeak(Double_t *x, Double_t *par) {
	...
	if (par[0]) {
	  ...
	  arg2 = (x[0] - par[1] + 20.5)/par[0];
	  arg3 = (x[0] - par[1] + 24.9)/par[0];
	  arg4 = (x[0] - par[1] + 33.4)/par[0];
	  arg5 = (x[0] - par[1] + 47.1)/par[0];
...
int fit0D(int angle, TFile* f2, FILE* f3, TFile* fFit){
	...
	gasout1_1clone->Scale(scalefactor); //product of ratio of gas in to gas out bcis and ratio of gas in to gas out live times
...
//********************************************************************
	...
	Double_t params[13] = {10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10};

	TF1 *fitfunc2 = new TF1("fitfunc2", fitfuncc, lu1, hu1, 13);
	fitfunc2->FixParameter(0,-2800.0);  		//constant
	fitfunc2->SetParameter(1,-0.01);  		//linear
	fitfunc2->SetParameter(2,10);  		//quad
	fitfunc2->FixParameter(3,9);  	//sigma
	fitfunc2->SetParameter(4,2756.0);  //mean
	fitfunc2->SetParameter(5,105.0);   //amp1
	fitfunc2->SetParameter(6,0.5);     //amp2   2+ states
	fitfunc2->FixParameter(7,0.0);    	//amp3  50->0.1
	fitfunc2->SetParameter(8,0.0);     //amp4   2+ states
	fitfunc2->SetParameter(9,0.5);    	//amp5  50->0.1
	fitfunc2->FixParameter(10,0.0);			//amp6
	fitfunc2->FixParameter(11,0.0);			//amp7
	fitfunc2->FixParameter(12,-0.00006);

	//fitfunc2->SetParLimits(0,-2820,-2650);
	fitfunc2->SetParLimits(1,-0.02,0);
	//fitfunc2->SetParLimits(2,0,10);
	fitfunc2->SetParLimits(2,0,50);
	//fitfunc2->SetParLimits(5,0,1000);
	fitfunc2->SetParLimits(6,0,50);
	//fitfunc2->SetParLimits(7,0,1000);
	fitfunc2->SetParLimits(8,0,50);
	fitfunc2->SetParLimits(9,0,50);
	...
	TF1 *bkdfuncu2 = new TF1("bkdfunc2",background, lu1, hu1, 3);
	...
	bkdfuncu2->SetParameter(0,-1*params[4]);   //constant
	bkdfuncu2->SetParameter(1,params[12]);   //linear
	bkdfuncu2->SetParameter(2,0.0);   //quad
	...
	bkdfuncu2->SetTitle("Background2");
	bkdfuncu2->SetLineColor(kGreen - 3);
	bkdfuncu2->Draw("same");
...
int fit3D(int angle, TFile* f2, FILE* f3, TFile* fFit){
	...
	Int_t lu1 = 2650; //2561 - 5
	Int_t hu1 = 3000; //2620 + 150
	...
	fitfunc2->SetParameter(0,6.5);  		//constant
	fitfunc2->FixParameter(1,0.0);  		//linear
	fitfunc2->FixParameter(2,0.0);  		//quad
	fitfunc2->FixParameter(3,10.0);  	//sigma
	fitfunc2->SetParameter(4,2700.0);  //mean
	fitfunc2->SetParameter(5,85.0);   //amp1
	fitfunc2->SetParameter(6,0.3);     //amp2   2+ states
	fitfunc2->FixParameter(7,0.0);    	//amp3  50->0.1
	fitfunc2->SetParameter(8,0.0);     //amp4   2+ states
	fitfunc2->SetParameter(9,0.4);    	//amp5  50->0.1
	fitfunc2->FixParameter(10,0.0);			//amp6
	fitfunc2->FixParameter(11,0.0);			//amp7

	fitfunc2->SetParLimits(0,0,300);
	fitfunc2->SetParLimits(5,0,1000);
...
int fit6D(int angle, TFile* f2, FILE* f3, TFile* fFit){
	...
	TF1 *fitfunc2 = new TF1("fitfunc2", fitfuncc, lu1, hu1, 12);
	fitfunc2->SetParameter(0,223.6);  		//constant
	fitfunc2->SetParameter(1,-0.0809);  		//linear
	fitfunc2->SetParameter(2,0);  		//quad
	fitfunc2->SetParameter(3,10.0);  	//sigma
	fitfunc2->SetParameter(4,2715.0);  //mean
	fitfunc2->SetParameter(5,226.8);   //amp1
	fitfunc2->SetParameter(6,0.1306);     //amp2   2+ states
	fitfunc2->FixParameter(7,0.0);    	//amp3  50->0.1
	fitfunc2->SetParameter(8,0.001);     //amp4   2+ states
	fitfunc2->SetParameter(9,0.175);    	//amp5  50->0.1
	fitfunc2->FixParameter(10,0.0);			//amp6
	fitfunc2->FixParameter(11,0.0);			//amp7
	...
	gausfuncu11->SetParameter(0,params[3]);  //Sigma
	gausfuncu11->SetParameter(1,params[4] - 26.0);  //amp2
	gausfuncu11->SetParameter(2,params[5]*params[6]);  //amp3  //*p5

	gausfuncu12->SetParameter(0,params[3]);  //Sigma
	gausfuncu12->SetParameter(1,params[4] - 31.6);  //Mean
	gausfuncu12->SetParameter(2,params[5]*params[7]);  //amp5

	gausfuncu13->SetParameter(0,params[3]);  //Sigma
	gausfuncu13->SetParameter(1,params[4] - 42.4);  //Mean
	gausfuncu13->SetParameter(2,params[5]*params[8]);  //amp5

	gausfuncu14->SetParameter(0,params[3]);  //Sigma
	gausfuncu14->SetParameter(1,params[4] - 59.3);  //Mean
	gausfuncu14->SetParameter(2,params[5]*params[9]);   //amp5
...
int fit9D(int angle, TFile* f2, FILE* f3, TFile* fFit){
		...
		Int_t lu1 = 2600; //2575 - 5
		Int_t hu1 = 2850; //2634 + 150
		...
		TF1 *fitfunc2 = new TF1("fitfunc2", fitfuncc, lu1, hu1, 12);
		fitfunc2->SetParameter(0,10);  		//constant
		fitfunc2->SetParameter(1,-0.002551);  		//linear
		fitfunc2->SetParameter(2,0);  		//quad
		fitfunc2->SetParameter(3,10.31);  	//sigma
		fitfunc2->SetParameter(4,2700.0);  //mean
		fitfunc2->SetParameter(5,102.0);   //amp1
		fitfunc2->SetParameter(6,0.2);     //amp2   2+ states
		fitfunc2->FixParameter(7,0.0);    	//amp3  50->0.1
		fitfunc2->SetParameter(8,0.001);     //amp4   2+ states
		fitfunc2->SetParameter(9,0.2167);    	//amp5  50->0.1
		fitfunc2->FixParameter(10,0.0);			//amp6
		fitfunc2->FixParameter(11,0.0);			//amp7
...
int fit12D(int angle, TFile* f2, FILE* f3, TFile* fFit){
		...
		TF1 *fitfunc2 = new TF1("fitfunc2", fitfuncc, lu1, hu1, 12);
		fitfunc2->SetParameter(0,116.6);  		//constant
		fitfunc2->SetParameter(1,-0.04095);  		//linear
		fitfunc2->SetParameter(2,0.0);  		//quad
		fitfunc2->SetParameter(3,10.68);  	//sigma
		fitfunc2->SetParameter(4,2750.0);  //mean
		fitfunc2->SetParameter(5,82.68);   //amp1
		fitfunc2->SetParameter(6,0.2097);     //amp2   2+ states
		fitfunc2->FixParameter(7,0.0);    	//amp3  50->0.1
		fitfunc2->SetParameter(8,0.1109);     //amp4   2+ states
		fitfunc2->SetParameter(9,0.3281);    	//amp5  50->0.1
		fitfunc2->FixParameter(10,0.0);			//amp6
		fitfunc2->FixParameter(11,0.0);			//amp7
...
int fit15D(int angle, TFile* f2, FILE* f3, TFile* fFit){
		...
		Int_t lu1 = 2625; //2598 - 5
		Int_t hu1 = 2875; //2656 + 150
		...
		TF1 *fitfunc2 = new TF1("fitfunc2", fitfuncc, lu1, hu1, 12);
		fitfunc2->SetParameter(0,13.65);  		//constant
		fitfunc2->SetParameter(1,-0.003654);  		//linear
		fitfunc2->SetParameter(2,0);  		//quad
		fitfunc2->SetParameter(3,10.07);  	//sigma
		fitfunc2->SetParameter(4,2725.0);  //mean
		fitfunc2->SetParameter(5,41.35);   //amp1
		fitfunc2->SetParameter(6,0.3833);     //amp2   2+ states
		fitfunc2->FixParameter(7,0.0);    	//amp3  50->0.1
		fitfunc2->SetParameter(8,0.3833);     //amp4   2+ states
		fitfunc2->SetParameter(9,0.6926);    	//amp5  50->0.1
		fitfunc2->FixParameter(10,0.0);			//amp6
		fitfunc2->FixParameter(11,0.0);			//amp7
...
int fit18D(int angle, TFile* f2, FILE* f3, TFile* fFit){
		...
		Int_t lu1 = 2650; //2579 - 5
		Int_t hu1 = 2900; //2639 + 150
		...
		TF1 *fitfunc2 = new TF1("fitfunc2", fitfuncc, lu1, hu1, 12);
		fitfunc2->SetParameter(0,10);  		//constant
		fitfunc2->SetParameter(1,-0.00304);  		//linear
		fitfunc2->SetParameter(2,0);  		//quad
		fitfunc2->SetParameter(3,7.384);  	//sigma
		fitfunc2->SetParameter(4,2750.0);  //mean
		fitfunc2->SetParameter(5,15);   //amp1
		...
		fitfunc2->SetParameter(6,0.4506);     //amp2   2+ states
		fitfunc2->SetParLimits(6,0,1000);
		...
		fitfunc2->FixParameter(7,0.0);    	//amp3  50->0.1
		fitfunc2->SetParameter(8,0.1793);     //amp4   2+ states
		fitfunc2->SetParameter(9,0.5972);    	//amp5  50->0.1
		fitfunc2->FixParameter(10,0.0);			//amp6
		fitfunc2->FixParameter(11,0.0);			//amp7
